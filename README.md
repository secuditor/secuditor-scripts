...
A partial collection of open source Python scripts (MIT License) developed for the **Secuditor project**. All **[modules](/scripts)** in this repository are **standalone**, and some may require the installation of third party packages.
